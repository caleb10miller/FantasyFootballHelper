...
with open(results_file, 'w') as f:
    ...
    predictions_file = f"logs/xgboost_regression/hyperparameter_tuning/test_predictions_{timestamp}.csv"
    ...
    if len(df_next_season) == 0:
        ...
        predictions_file_2025 = f"logs/xgboost_regression/hyperparameter_tuning/predictions_2025.csv"
